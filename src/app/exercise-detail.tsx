...
export default function ExerciseDetailModal() {
  ...
  return (
    <BottomSheetModal
      ...
      backgroundStyle={{ backgroundColor: isDark ? "#1f2937" : "#ebecf0" }}
    >
          ...
          <View className="flex-1 pb-6">
            ...
            <View className="px-6">
              ...
              <View className="flex-row items-center justify-between mb-4 mt-6">
                <Text className="text-gray-900 dark:text-white text-2xl font-bold flex-1 mr-3">
                  {exercise.name}
                </Text>

                <View
                  className="px-3 py-1 rounded-full"
                  style={{ backgroundColor: getDifficultyBgColor(exercise.difficulty) }}
                >
                  <Text
              ...
              <View className="gap-3 mb-6">
                ...
                {exercise.videoUrl && (
                  <Pressable
                    className="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl p-4 flex-row items-center justify-center"
                  ...
                  >
                    <Ionicons name="play" size={20} color={isDark ? "#d1d5db" : "#374151"} />
                ...
                {(aiGuidanceMutation.data || aiGuidanceMutation.isPending) && (
                  <View className="mb-6">
                    <View className="flex-row items-center mb-6">
                      ...
                      <Text className="text-xl font-semibold text-gray-800 dark:text-white ml-2">
                        AI Coach says...
                      </Text>
                    </View>
                    {aiGuidanceMutation.isPending ? (
                      <View className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 items-center">
