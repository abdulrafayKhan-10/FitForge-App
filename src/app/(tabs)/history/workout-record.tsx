...
export default function WorkoutRecord() {
  ...
  if (isLoading || !workout) {
    return (
      <View className="flex-1 bg-gray-50 dark:bg-gray-900 justify-center items-center">
        <Text className="text-gray-600 dark:text-gray-400">Loading workout details...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View className="bg-white dark:bg-gray-800 mx-4 mt-4 mb-6 rounded-2xl p-4 border border-gray-100 dark:border-gray-700">
        ...
        <View className="flex-row items-center mb-3">
          <Ionicons
            ...
            style={{ marginRight: 8 }}
          />
          <Text className="text-gray-700 dark:text-gray-300">{exerciseCount} exercises</Text>
        </View>
        ...
        <View className="flex-row items-center mb-3">
          <Ionicons
            ...
            style={{ marginRight: 8 }}
          />
          <Text className="text-gray-700 dark:text-gray-300">{totalSets} total sets</Text>
        </View>
