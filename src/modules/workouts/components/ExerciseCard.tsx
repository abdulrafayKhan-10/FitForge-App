...
export default function ExerciseCard({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      className="bg-white dark:bg-gray-800 rounded-xl p-4 mb-3 mx-2 shadow-sm border border-gray-100 dark:border-gray-700"
    >
      <View className="flex-row items-center justify-between">
        <View className="flex-1">
          <Text className="text-lg font-lexend-semibold text-gray-900 dark:text-white mb-1">
            {exercise.name}
          </Text>
