...
const HistoryCard: React.FC<HistoryCardProps> = ({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.8}
      className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl mb-4 mx-4 p-4 relative"
      style={{
        shadowColor: "#000",
        shadowOffset: {
          width: 0,
    ...
    >
      ...
      <View className="mb-2">
        {exerciseNames.map((name, index) => (
          <Text key={index} className="text-gray-700 dark:text-gray-300 text-sm mb-1">
            • {name}
          </Text>
        ))}
        {hasMoreExercises && (
